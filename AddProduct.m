...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    NSString *fname1 = [NSString stringWithFormat:@"%@",[_txtProductName.text stringByReplacingOccurrencesOfString:@" " withString:@""]];
    [self saveImage:self.imgProductPhoto.image forPerson:fname1];
    photo_filename = [[_txtProductName.text stringByReplacingOccurrencesOfString:@" " withString:@""] stringByAppendingString:@".png"];
